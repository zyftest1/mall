...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\bindMobile.css?1607171728.25">
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\accountDialog.css?1607171728.25">
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\authpic.css?1607171728.25">
		...
		<script>
			...
			var Meilishuo = {
				"config": {
					"nt": "1yQyN1tU7ssTVQ5GeZ16w5r3oGl2ewiLpNviz7Ur/tC5nN21cYGdLwq1rFqLuSQu",
					"main_site_domain": "/",
					"server_url": "/",
	...
	<body>
		...
		<div class="settings">
			...
			<div class="settings_box"> <strong class="settings_title">手机绑定</strong>
				<fieldset class="bindMobile">
					<form id="bindMobileForm" method="post" onsubmit="return false" action="">
						<div class="form-list"><label class="account-label" for="mobile">手机号</label> <input class="lipt l_ipt width-160"
							 autocomplete="off" id="mobile" name="mobile" type="text" value="137****1354" disabled=""> <span class="color-666">已绑定手机，</span>
							<a href="changeMobile.jsp" class="color-pink">更换绑定</a>
						</div>
					</form>
				</fieldset>
			</div>
		...
		<!-- 弹窗 -->
		<script type="text/jsp" id="accountDialog">
			<div class="popup" id="popup">
				<div class="box">
					<p class="title">
						<?= this.title ?>
							<a href="javascript:;" class="bg-icons"></a>
					</p>
					<p class="tips">
						<?= this.message ?>
					</p>
					<div class="btn-box">
						<? this.buttons.forEach(function(item){ ?>
							<a href="javascript:;" data-action="<?= item.action ?>" class="btn-pink btn">
								<?= item.text ?>
							</a>
							<? }); ?>
					</div>
		...
		<script src="pc\~page\pcenter\common\navbar page\account\bindMobile\step3 base.bin?1607171728.25"></script>
		<script>
			fml.use('page/pcenter/common/navbar');;
			fml.use('page/account/bindMobile/step3');;
			fml.use('base');;
			fml.iLoad();
		</script>
	</body>

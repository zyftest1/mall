<%@ page contentType="text/html;charset=UTF-8" language="java" %><!--[if IE 7]><jsp class="ie7 lt-ie10"><![endif]-->
...
<html>
	...
	<body>
		<div class="head">
					...
					<ul>
						...
						<li class="drop">
							...
							<ul class="down">
								...
								<li>
									<a href="businessServer.jsp" target="_blank">商家服务</a>
								</li>
								<li>
			...
			<div id="com-search">
				<div class="inner">
					<a href="index.jsp" class="logo"> <img src="http://d02.res.meilishuo.net/pic/_o/50/a7/735e2614e3911e621f0446e54597_204_52.c5.png"
						 alt=""> </a>

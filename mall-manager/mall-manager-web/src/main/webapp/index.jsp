            ...
            <ul>
                <li class="drop">
                    ...
                    <ul class="down account">
                        <li>
                            <a href="setPersonal.jsp" target="_blank">账号与安全</a></li>
                        <li>
                ...
                <li class="drop">
                    ...
                    <ul class="down">
                        <li>
                            <a href="mylike.jsp" target="_blank">收藏宝贝</a></li>
                        <li>
                            <a href="mylikestore.jsp" target="_blank">收藏店铺</a></li>
                    </ul>
                </li>
                <li class="drop cart-wrapper">
                    ...
                    <div class="hidden">
                        ...
                        <p class="cart-account">
                            ...
                            <a class="check-cart" href="mycart.jsp" target="_blank">查看购物车</a></p>
                    </div>
                </li>
                <li>
                ...
                <li class="drop">
                    ...
                    <ul class="down">
                        ...
                        <li>
                            <a href="ruleCenter.jsp" target="_blank">规则中心</a></li>
                    </ul>
                </li>
                <li>

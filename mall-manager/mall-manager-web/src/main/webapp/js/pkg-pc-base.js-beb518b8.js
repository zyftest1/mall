! function() {
	...
	try {
		! function(e) {
			...
			function n() {
				return "indexedDB" in e ? !0 : !!(e.indexedDB = e.indexedDB || e.mozIndexedDB || e.webkitIndexedDB || e.msIndexedDB)
			}
...
! function(e, t) {
	...
	Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, Z.extend({
		...
		domManip: function(e, t) {
			...
			if(g || l > 1 && "string" == typeof p && !Q.checkClone && Oe.test(p)) return this.each(function(n) {
				var r = c.eq(n);
				g && (e[0] = p.call(this, n, r.jsp())), r.domManip(e, t)
			});
	...
	Z.fn.load = function(e, t, n) {
		...
		return a >= 0 && (r = Z.trim(e.slice(a)), e = e.slice(0, a)), Z.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), s.length > 0 && Z.ajax({
			...
			o = arguments, s.jsp(r ? Z("<div>").append(Z.parseHTML(e)).find(r) : e)
	...
	Z.offset = {
		...
		position: function() {
			if(this[0]) {
				...
				return "fixed" === Z.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), Z.nodeName(e[0], "jsp") || (r = e.offset()), r.top += Z.css(e[0], "borderTopWidth", !0), r.left += Z.css(e[0], "borderLeftWidth", !0)), {
		...
		offsetParent: function() {
			return this.map(function() {
				for(var e = this.offsetParent || Pt; e && !Z.nodeName(e, "jsp") && "static" === Z.css(e, "position");) e = e.offsetParent;
				return e || Pt
			})
		}
	}), Z.each({
...
! function(e, t, n) {
	...
	e.fn.init = function(t, n, a) {
		var i;
		return t && "string" == typeof t && !e.isPlainObject(n) && (i = y.exec(e.trim(t))) && i[0] && ("<" !== t.charAt(0) && r("$(jsp) HTML strings must start with '<' character"), i[3] && r("$(jsp) HTML text after last tag is ignored"), "#" === i[0].charAt(0) && (r("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), n && n.context && (n = n.context), e.parseHTML) ? g.call(this, e.parseHTML(i[2], n, !0), n, a) : g.apply(this, arguments)
...
define("core/core", [], function() {
	...
	if(o.disabled = !1, o.set = function() {}, o.get = function() {}, o.remove = function() {}, o.clear = function() {}, o.transact = function(t, e, n) {
		...
		var c, l;
		try {
			l = new ActiveXObject("jspfile"), l.open(), l.write('<script>document.w=window</script><iframe src="/favicon.ico"></iframe>'), l.close(), c = l.w.frames[0].document, r = c.createElement("div")
		} catch(f) {

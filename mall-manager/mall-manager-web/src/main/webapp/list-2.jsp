	...
	<body>
		...
		<div id="com-foot">
			<div class="inner">
				...
				<div class="flist">
					<h4>关于我们</h4>
					<div><a href="aboutus.jsp" target="_blank">关于Beauty Show</a></div>
				...
				<div class="flist service">
					<h4>Beauty Show微信服务号</h4> <img class="qrcode" src="p2\160802\7e_61hjl8kjfjfagkg3cdaj05fghck9c_100x100.png" alt="Beauty Show服务号二维码">
				</div>

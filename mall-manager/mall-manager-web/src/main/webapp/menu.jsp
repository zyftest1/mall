    ...
    <ul>
        ...
        <li>
            <ul class="menu-children">
                <li><a href="order_list.html" title="商品列表" target="mainCont">订单查询列表</a></li>
                <li><a href="order_list1.html" title="商品列表" target="mainCont">订单结算</a></li>
            </ul>
        </li>
...
<%--                <li><a href="recycle_bin.html" title="商品分类" target="mainCont">商品回收站</a></li>--%>
        ...
        <li>
            <ul class="menu-children">
                <li><a href="product_list.html" title="会话功能" target="mainCont">客服中心</a></li>
            </ul>
        </li>

...
<html>
	...
	<head>
     ...
     <meta name="chinaz-site-verification" content="500e4417-e595-40ac-98da-dec66c97a9e5" /> -->
		...
		<link rel="stylesheet" href="new1\v1\fxihe\4ca212cfc3a85ff40525521ff0f7510f\A1f7679b27a2000402.css">
		<script type="text/javascript">
			PTP_PARAMS = {
				"c_action": "cube%40%40newbags0818pc",
				"ptp_cnt_a": "1",
				"time": "1471486198000",
				"ptp_cnt_b": "_mf1_840_12596"
			}
		</script>
	...
	<div id="com-search">
		...
		<div id="body_wrap">
			<div class="page_activity   " data-time="">
				<div class="module_row module_row_130716 MOD_ID_35" data-mid="130716" data-versionid="367425" data-editable="1">
					<div class="mod_row MCUBE_MOD_ID_35 clearfix" style="width: 960px;" id="singlebanner" style="background-color: ;">
				...
				<div class="module_row module_row_130736 MOD_ID_577" data-mid="130736" data-versionid="367476" data-editable="1">
					<div class="mod_row MCUBE_MOD_ID_577">
				...
				<div class="module_row module_row_130737 MOD_ID_155" data-mid="130737" data-versionid="367478" data-editable="1">
					<div class="mod_row MCUBE_MOD_ID_155">
							...
							<script id="doTtemplate-single-goods" type="text/template">
								<div class="single-goods clearfix rec-show-log">
									...
									<div class="iwf fl show-log-item data-ptp-item" data-log-content="{{=items.acm}}" data-log-index="{{=index}}">
										<a data-ext-acm="{{=items.acm}}" href="{{=items.item_url}}" class="img-wrap J_dynamic_imagebox loading_bg_120 useOrg" img-src="{{=items.image}}" target="_blank" style="padding-bottom: 150%;">
											{{?items.discount}}
											<div class="lefttop-discount">{{=items.discount}}
												<div>折</div>
											</div>
											{{?}}
										</a>
				...
				<div class="module_row module_row_130738 MOD_ID_155" data-mid="130738" data-versionid="367480" data-editable="1">
					<div class="mod_row MCUBE_MOD_ID_155">
				...
				<div class="module_row module_row_130739 MOD_ID_155" data-mid="130739" data-versionid="367486" data-editable="1">
					<div class="mod_row MCUBE_MOD_ID_155">
		...
		<script type="text/javascript" src="js\logger.js$1471486195.js"></script>
		<script src="new1\v1\fxihe\1edf4e0a91804a2b3502c8ed0354e1b9\A128679b27a2000402.js"></script>

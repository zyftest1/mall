...
<html>
	...
	<body>
		...
		<div class="header_mid clearfix">
			<div class="wrap">
				<a rel="nofollow" href="index.jsp" class="logo" title="美丽说首页"></a>
						...
						<ul class="doota_ul">
							<li>
								...
								<ul class="mu_nav_item">
									<li>
										<a href="orderlist.jsp#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6">全部订单</a>
									</li>
									
									<li class="c">
										<a href="order_unshipped.jsp#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 待收货 <i id="unReceivedOrder"
											 class="mu_nav_count"><i class="mu_nav_count_arw"></i></i>
										</a>
									</li>
									<li>
										<a href="order_received.jsp#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 待评价 <i id="waitingRateOrder"
											 class="mu_nav_count"><i class="mu_nav_count_arw"></i></i>
										</a>
									</li>
									<li>
										<a href="order_DELETED.jsp#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 退货退款 <i class="mu_nav_count"><i
												 class="mu_nav_count_arw"></i></i>
										</a>
									</li>
									<!-- 新增，stage=8 回收站订单 -->
									<li>
										<a href="order_DELETED.jsp#&amp;_uk=sr67mlrhfousumpjbc6n7bdg82rvnyapglqybeg6"> 订单回收站 <i id="recyleOrder"
											 class="mu_nav_count"><i class="mu_nav_count_arw"></i></i>
										</a>
									</li>
								</ul>
							...
							<li>
								<a class="menu_pcenter" href="footprint.jsp#"> 我的足迹 <em class="little-triangle"></em><em class="little-triangle-hover"></em>
								</a>
							</li>
							<li>
							...
							<li>
								...
								<ul>
									<li>
										<a href="setPersonal.jsp">我的信息</a>
									</li>
									<li>
										<a href="setAvatar.jsp#">个人头像</a>
									</li>
								</ul>
							</li>
							<li>
								...
								<ul>
									<li>
										<a href="setPassword.jsp">用户密码</a>
									</li>
									<li>
										<a href="payPassword.jsp">支付密码</a>
									</li>
									<li>
										<a href="bindMobile.jsp">手机绑定</a>
									</li>
									<li>
										<a href="loginEqm.jsp#">登录设备</a>
									</li>
								</ul>
							</li>
						</ul>
			...
			<div class="wrap foot_wrap clearfix">
					...
					<div class="info_text">
						<p>营业执照注册号：
							<a rel="nofollow" href="http://s6.mogucdn.com/pic/140924/8qc9_ieydgn3emqztszbxmmytambqmmyde_1502x2246.jpg"
							 target="_blank">110108013011072</a>
						</p>
						<p>京ICP备11031139号</p>
						<p>
				...
				<div class="foot_link">
					<dl class="link_company">
						...
						<dd>
							<a rel="nofollow" href="contactus.jsp" target="_blank">联系我们</a>
						</dd>
					</dl>
					<dl class="link_consumer">
						<dt>消费者</dt>
						<dd>
							<a rel="nofollow" href="noviceGuide.jsp" target="_blank">新手指南</a>
						</dd>
						<dd>
							<a rel="nofollow" href="serviceEnsure.jsp" target="_blank">服务保障</a>
						</dd>
					</dl>

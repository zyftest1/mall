...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\payPassword.css?1607171729.25">
		...
		<script>
			...
			var Meilishuo = {
				"config": {
					"nt": "1yQyN1tU7ssTVQ5GeZ16wxYUq0HpiRPu9rknVSAyQuLoW/R9/iwLGubxqtRrvIov",
					"main_site_domain": "/",
					"server_url": "/",
	...
	<body>
		...
		<div class="settings">
			...
			<div class="settings_box"> <strong class="settings_title">支付密码</strong>
				<div class="payPassword"> <span class="warning">请前往手机端修改支付密码</span> </div>
			</div>
		</div>
		<div id="com-foot">
			<div class="inner">
		...
		<script src="pc\~page\pcenter\common\navbar base.bin?1607171729.25"></script>
		<script>

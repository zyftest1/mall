...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\common-1.css?1607171726.25">
		<link rel="stylesheet" type="text/css" href="pc\css\page\account\setAvatar.css?1607171726.25">
		...
		<script>
			...
			var Meilishuo = {
				"config": {
					"nt": "1yQyN1tU7ssTVQ5GeZ16w2fsGY1aingwLEUZTAJdV1PmzVyi+wMmjxq9Da/nUoeN",
					"main_site_domain": "/",
					"server_url": "/",
	...
	<body>
		...
		<div class="settings">
			...
			<div class="settings_box"> <strong class="settings_title">个人头像</strong>
				<fieldset>
					<div class="setAvatar">
						<form id="setAvatar" method="post" action="/api/profile/avatar/upload" target="upload_file" enctype="multipart/form-data">
							<div>
								<div class="img_submit"> <span>选择上传的图片</span> <input type="file" name="file" class="img_submit_in" id="img_submit">
								</div> <input type="submit" style="display:none;" id="uploadBtn"> <iframe id="get_upload_file" name="upload_file"
								 class="none_f" frameborder="0"> </iframe>
							</div>
							<p>建议使用正方形的图片，支持JPG、GIF、JPEG、PNG格式，8M以内</p> <img src="http://s2.mogucdn.com/new1/v1/bdefaultavatar/03.jpg" class="original">
							<div class="clear_both"></div>
						</form> <input type="button" name="save_thumbnail" data-uname="阿猫来了" value="确 认" id="set_submit" class="ext_submit">
		...
		<script src="pc\~page\pcenter\common\navbar page\account\setAvatar\setAvatar base.bin?1607171726.25"></script>
		<script>
			fml.use('page/pcenter/common/navbar');;
			fml.use('page/account/setAvatar/setAvatar');;
			fml.use('base');;
			fml.iLoad();
		</script>
	</body>

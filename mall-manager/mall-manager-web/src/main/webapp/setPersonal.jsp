		...
		<div class="head">
			<div id="com-topbar">
				<div class="inner">
					<ul>
						<li class="drop">
							<a href="setPersonal.jsp" class="nick" target="_blank">
						...
						<li class="drop">
							<a href="mylike.jsp" target="_blank">
						...
						<li class="drop cart-wrapper">
							<a target="_blank" href="mycart.jsp" class="my-cart">
								<em class="cart"></em>我的购物车</a>
							<div class="hidden">
								<ul class="cart-goods"></ul>
								<p class="cart-account">
									<span>购物车里还有
										<a class="num" href="mycart.jsp" target="_blank"></a>件商品</span>
									<a class="check-cart" href="mycart.jsp" target="_blank">查看购物车</a>
								</p>
							</div>
						</li>
						<li>
							<a href="/order.do?_method=orderTotal" target="_blank">
							...
							<ul class="sec_attr">
								<li class="list">
									<div class="list_cont">
										...
										<samp class="corner">
											<img src="http://s16.mogucdn.com/p1/160810/idid_ifrtom3dmqygcojumezdambqhayde_6x10.png"></samp>
									</div>
									<ul class="nav_list">
										<li>
											<h4>
								...
								<li class="list">
									...
									<ul class="nav_list">
										...
										<li>
											<h4>
												<a href="list.jsp#10059253?action=bags&mt=12.12829.r131369.16000&acm=1.mce.2.12829.0.0.16000_131369"
												 target="_blank">畅销热卖</a></h4>
											<p>
				...
				<fieldset class="setPersonal">
					<form id="setPersonForm" method="post" onsubmit="return false" action="">
						<div class="form-list">
							...
							<input id="register_mail" name="register_mail" autocomplete="off" class="l_ipt input_disable" type="text" value=""
							 disabled="disabled">
							<strong></strong>
						</div>
						<div class="form-list">
							<label class="account-label">真实姓名</label>
							<input id="true_name" name="true_name" autocomplete="off" class="l_ipt" type="text" value="">
							<strong></strong>
						</div>
						<div class="form-list">
							<label class="account-label">昵称</label>
							<input id="nickname" name="nickname" autocomplete="off" class="l_ipt" type="text" value="">
							<strong></strong>
						</div>
						<div class="gender" id="gender">
							<label class="account-label">性别</label>
							<input name="gender" id="female" type="radio" value="2" class="regular-radio">
							<label for="female" class="regular-radio-label"></label>
							<span>女</span>
							<input name="gender" id="male" type="radio" value="1" class="regular-radio">
                  ...
                  <![endif]-->
						<div class="form-list" id="birthday-list">
							...
							<input id="birthday" readonly="" class="laydate-icon" name="birthday" autocomplete="off" class="l_ipt" type="text"
							 value="" onfocus="HS_setDate(this)">
							<strong></strong>
						</div>
						...
						<div class="form-list" id="job-list" data-job="0">
							...
							<div class="select-container job-select">
						...
						<div class="form-list">
							...
							<textarea id="introduction" class="introduction" name="introduction"></textarea>
							<br>

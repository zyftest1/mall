		...
		<div class="settings">
			<div class="pcenter_navBar">
				...
				<ul class="pcenter_navBar_ul">
					...
					<li>
						<a class="menu_order" href="/bsAddress.do?_method=address&userId=${sessionScope.bsUserAccount.ID}&receiveName=${sessionScope.bsUserAccount.bsName}">收货地址
							<em class="little-triangle"></em>
							<em class="little-triangle-hover"></em>
						</a>
					</li>
		...
		<div id="com-foot">
			<div class="inner">
				...
				<div class="flist service">
					<h4>Beauty Show微信服务号</h4>
					<img class="qrcode" src="http://s7.mogucdn.com/p2/160802/7e_61hjl8kjfjfagkg3cdaj05fghck9c_100x100.png" alt="Beauty Show服务号二维码">
				</div>

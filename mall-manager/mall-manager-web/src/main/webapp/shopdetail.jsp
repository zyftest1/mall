...
<head>
    ...
    <meta name="description" content="来自蘑菇街优店裙子_连衣裙_服饰鞋包_女装家又有一款充满仙气的裙子贡献给菇凉们了~这款裙裙是采用雪纺面料的，亲自试穿过，面料特别舒服，清清凉凉的，然后有里衬，也不会透，夏日穿特别合适！荷叶袖的设计，手臂有肉肉的菇凉也不用担心了~的夏季韩版修身荷叶袖连衣裙，发现当季最潮衣服和爱丽缇旗舰店搭配心得。">
...
<%--        })--%>
<%--        function X() {--%>
<%--            var sizex = ${"#sizex"}.prop("checked");--%>
<%--            if(sizex){--%>
<%--                ${requestScope.goods.stock = requestScope.bsComStockS.stock}--%>
<%--            }--%>
<%--        }--%>
<%--        function M() {--%>

<%--            var sizex = ${"#sizem"}.prop("checked");--%>
<%--            if(sizex){--%>
<%--                ${requestScope.goods.stock = requestScope.bsComStockM.stock}--%>
<%--            }--%>
<%--        }--%>
<%--        function L() {--%>

<%--            var sizex = ${"#sizel"}.prop("checked");--%>
<%--            if(sizex){--%>
<%--                ${requestScope.goods.stock = requestScope.bsComStockL.stock}--%>
<%--            }--%>
<%--        }--%>
<%--        function XL() {--%>

<%--            var sizex = ${"#sizexl"}.prop("checked");--%>
<%--            if(sizex){--%>
<%--                ${requestScope.goods.stock = requestScope.bsComStockXL.stock}--%>
<%--            }--%>
<%--        }--%>
<%--        function XXL() {--%>

<%--            var sizex = ${"#sizexxl"}.prop("checked");--%>
<%--            if(sizex){--%>
<%--                ${requestScope.goods.stock = requestScope.bsComStockXXL.stock}--%>
<%--            }--%>
<%--        }--%>
<%--    </script>--%>
    ...
    <script type="text/javascript">
        ...
        //     alert(item);
        // })
        // $('input[name="radiobutton"]').each(function(){alert(this.value);});
        $(function () {
            $('input[name="radiobutton"]').click(function(){
                ...
                var size = $(this).val();
                $.post({
                    url:"/car.do?_method=stock&cID=${requestScope.goods.cID}&size=size",
                    data:{size:size},
                    dataType:"text",
                    success:function (data,status) {
                        if(data == "S"){
                            ...
                            $("#sizeStockXXL").hide();
                            $("#sizeStockS").show();
                            $("#sizeStockS").text("${bsComStockS.stock}");
                        }else if(data == "M"){
                            $("#sizeStock").hide();
                            $("#sizeStockS").hide();
                            $("#sizeStockL").hide();
                            ...
                            $("#sizeStockXXL").hide();
                            $("#sizeStockM").show();
                            $("#sizeStockM").text("${bsComStockM.stock}");
                            ...
                            $("#sizeStockXXL").hide();
                            $("#sizeStockL").show();
                            $("#sizeStockL").text("${bsComStockL.stock}");
                            ...
                            $("#sizeStockXXL").hide();
                            $("#sizeStockXL").show();
                            $("#sizeStockXL").text("${bsComStockXL.stock}");
                        }else if(data == "XXL"){
                            $("#sizeStock").hide();
                            $("#sizeStockS").hide();
                            $("#sizeStockM").hide();
                            ...
                            $("#sizeStockXL").hide();
                            $("#sizeStockXXL").show();
                            $("#sizeStockXXL").text("${bsComStockXXL.stock}");
                        }
                    }
                })
            })
                                        ...
                                        <dl class="clearfix">
                                            ...
                                            <dd class="num clearfix">
                                                ...
                                                <div class=" goods-stock fl">
                                                    库存
                                                    <span id="sizeStock">${requestScope.goods.stock}</span>
                                                    <span id="sizeStockS" ></span>
                                                    <span id="sizeStockM" ></span>
                                                    <span id="sizeStockL" ></span>
                                                    <span id="sizeStockXL" ></span>
                                                    <span id="sizeStockXXL" ></span>件</div>
                        ...
                        <div class="ui-bd">
                            ...
                            <div class="shop-btns">
                                <a rel="nofollow" class="J-shop-follow shop-follow  btn-faved shop-followed " href="javascript:;" data-shopid="110fni1q">
                                    已收藏                         </a>
                                <a class="btn-goto" href="shop.jsp#110fni1q">进入店铺</a>
                            </div>

                            <div class="shop-search">
                                <i class="line"></i>
                                <form action="shop.jsp#110fni1q/search/index" method="get" id="J_ShopSearch">
                    ...
                    <div class="ui-box classify-info">
                        ...
                        <div class="ui-bd">
                            ...
                            <ul class="classify-list">
                                <li>
                                    <a href="shop.jsp#110fni1q/index/total">全部商品</a>
                                </li>
                                <li>
                                    <a href="shop.jsp#110fni1q/list/index?categoryId=10702384">热卖单品</a>
                                </li>

...
<html>
	...
	<head>
		...
		<script>
			...
			var Meilishuo = {
				"config": {
					"nt": "1yQyN1tU7ssTVQ5GeZ16w4QPg8wV0SCtm1cyPWmtRC+XU+c4uyGkzPVegLvL4o6X",
					"main_site_domain": "/",
					"server_url": "/",
		...
		<div class="page">
			<div class="detail_con">
				<div class="hep_detail">
					<h2 class="detail_title">购物帮助</h2>
					<div class="help_con">
						<div class="desc">
							<p style="font-size: 14px; line-height: 2;"><span style="line-height:2"><span style="font-size:14px">一．支付方式<br>
										白付美，余额，银行卡支付，支付宝，微信，网上银行</span></span>
							</p>

							<p style="font-size: 14px; line-height: 2;"><span style="line-height:2"><span style="font-size:14px">二．售后服务政策<br>
										&middot;7天无理由退货<br>
										&middot;退货补运费<br>
										&middot;先行赔付&nbsp;<br>
										&middot;72小时发货</span></span>
							</p>
						</div>
					</div>
				</div>

...
<%--    </script>--%>
    ...
    <script type="text/javascript">
        ...
        function change() {
            ...
            img.src="/codeImg.do"+Math.random();
            // img.src="/codeImg.do"+new Date();
        }
    </script>
</head>
<body>
    ...
    <div class="main-wrap">
        <div class="wrapper">
            <div class="center-box">
                <form action="/BsUserAccount.do?_method=sign" method="post">
                    <div class="box-hd">
...
<%--                        <img id="img" style="cursor: pointer" src="/codeImg.do" onclick="change()">--%>
                    </label>
                    <label class="txtin-box">
                    ...
                    <button class="tj" type="submit" id="submit" value="注&ensp;册">注&ensp;册</button>
